					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse"
							...
							<ul class="nav navbar-nav navbar-right" id="top-menu">
								...
								<li><a href="http://ddebbie.com/#about-us">About Us</a></li>
								<li><a href="http://ddebbie.com/#features">Features</a></li>
								<li><a href="http://ddebbie.com/#screenshots">Screenshots</a></li>
								<li><a href="http://ddebbie.com/#fleet">Our Fleet</a></li>
								<li><a href="http://ddebbie.com/#ddebbiedriver">Become a Driver</a></li>
								<li><a href="http://ddebbie.com/#contact-us">Contact Us</a></li>
								<li>
...
<section>
	...
	<section class="iq-breadcrumb overview-block-pt text-center iq-bg iq-bg-fixed iq-over-black-90 iq-box-shadow" style="background: url(images/about/05.jpg);" >
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <div class="heading-title iq-breadcrumb-title iq-mtb-100">
                        <h3 class="title iq-tw-8 iq-font-white"><span>Drive</span> More. Earn More.</h3>
			  ...
			  <!--<div class="col-lg-12 blue">
				...
				<div class="row form-div">
					...
					<div class="col-lg-12">
						<div class="col-lg-4">
							<div class="form-group">
								<label class="label-custom" for="address">Address*</label>
						...
						<div class="col-lg-4">
							<div class="form-group">
								<label class="label-custom" for="postal_code">City*</label>
								<input type="text" class="form-control" id="city" name="city" required="required">
							</div>
						</div>
						<div class="col-lg-4">
							<div class="form-group">
								<label class="label-custom" for="postal_code">Postal Code*</label>
					...
					<div class="col-lg-12">
						<div class="col-lg-4">
							<div class="form-group">
								<label class="label-custom" for="contact_number">Contact Number*</label>
						...
						<div class="col-lg-4" style="display:none;">
							<div class="form-group">
								<label class="label-custom" for="confirm_password">Confirm password*</label>
					...
					<div class="col-lg-12">
						<div class="col-lg-4">
							<div class="form-group">
								...
								<label class="label-custom" for="address" >I accept <a href="javascript:void(0)" data-toggle="modal" data-target="#temsCndModal">Terms and conditions</a>*</label>
					...
					<div id="vehiclesInfo">
						<div class="vehicleInfo">
							...
							<div class="col-lg-12">
								<div class="col-lg-4">
									<div class="form-group">
										<label class="label-custom" for="vehicle_type">Vehicle Type*</label>
							...
							<div class="col-lg-12">
								<div class="col-lg-3">
									<div class="form-group">
										<label class="label-custom" for="vehicle_type">Model*</label>
										<input type="text" id="vehicles_model" name="vehicles_model[]" class="form-control" required="required">
									</div>
								</div>
								<div class="col-lg-3">
									<div class="form-group">
										<label class="label-custom" for="vehicle_type">Make*</label>
										<input type="text" id="vehicles_make" name="vehicles_make[]" class="form-control" required="required">
									</div>
								</div>
								<div class="col-lg-3">
									<div class="form-group">
										<label class="label-custom" for="vehicle_number">Plate Number*</label>
										<input type="text" class="form-control" id="vehicle_number" name="vehicle_number[]" required="required">
									</div>
								</div>
								<div class="col-lg-3">
									<div class="form-group">
										<label class="label-custom" for="num_of_doors">Num. Of Doors*</label>
										<input type="text" class="form-control" id="num_of_doors" name="num_of_doors[]">
									</div>
								</div>
								<div class="col-lg-4" style="display:none">
									<div class="form-group">
										<label class="label-custom" for="ownership">Ownership</label>
							...
							<div class="col-lg-12">
								<div class="col-lg-4">
									<div class="form-group">
										<label class="label-custom" for="licence_num">Type Of Licence*</label>
								...
								<div class="col-lg-4" style="display:none;">
									<div class="form-group">
										<label class="label-custom" for="licensing">Licensing</label>
										<input type="text" id="licensing" name="licensing[]" class="form-control">
									</div>
								</div>
								<div class="col-lg-4">
									<div class="form-group">
										<label class="label-custom" for="insurance_comp_name">Insurance Comp. Name</label>
										<input type="text" class="form-control" id="insurance_comp_name" name="insurance_comp_name[]">
									</div>
								</div>
								<div class="col-lg-4">
									<div class="form-group">
										<label class="label-custom" for="insurance_comp_name">Wheel chair facility</label><br/>
										<label class="label-custom" ><input type="radio" value="0" name="wheel_chair_facility[]"> No</label>&nbsp;&nbsp;
							...
							<div class="col-lg-12">
								<div class="col-lg-3">
									<div class="form-group">
										<label class="label-custom" for="ownership_doc">Ownership</label>
										<input type="file" id="ownership_doc" name="ownership_doc" class="form-control">
									</div>
								</div>
								<div class="col-lg-3">
									<div class="form-group">
										<label class="label-custom" for="insurance_policy_doc">Insurance Policy</label>
										<input type="file" class="form-control" id="insurance_policy_doc" name="insurance_policy_doc">
									</div>
								</div>
								<div class="col-lg-3">
									<div class="form-group">
										<label class="label-custom" for="driver_licence_doc">Driver Licence</label>
										<input type="file" class="form-control" id="driver_licence_doc" name="driver_licence_doc">
									</div>
								</div>
								<div class="col-lg-3">
									<div class="form-group">
										<label class="label-custom" for="vehicle_safty_doc">Vehicle Safty</label>
										<input type="file" class="form-control" id="vehicle_safty_doc" name="vehicle_safty_doc">
									</div>
								</div>
							</div>
							<!--<div class="col-lg-12">
	...
	<div class="form-group"></div>
		...
		<input type="submit" value="Submit" name="register" class="button pull-right iq-mt-40" style="padding-left: 60px; padding-right: 60px; float: none; margin: auto;"><br><br></div>
	</div>
	</div>                                                 
	</div>
		</form>
